...
type Catalog struct {
	...
	// gvhToType allows mapping a GroupVersionHook to the corresponding RuntimeHook function.
	gvhToType map[GroupVersionHook]reflect.Type

	// gvhToType allows mapping a RuntimeHook to the corresponding GroupVersionHook.
	typeToGVH map[reflect.Type]GroupVersionHook

	// gvhToHookDescriptor allows mapping a GroupVersionHook to the corresponding hook descriptor.
