		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"external": {
						SchemaProps: spec.SchemaProps{
							Description: "External defines an external patch. FIXME(sbueringer): internal or external only => validate",
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"generateExtension": {
						SchemaProps: spec.SchemaProps{
							Description: "GenerateExtension references an extension which is called to generate patches. FIXME(sbueringer): Q: Fine that GenerateExtension is optional as well?",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"validateExtension": {
						SchemaProps: spec.SchemaProps{
							Description: "GenerateExtension references an extension which is called to validate the topology.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
